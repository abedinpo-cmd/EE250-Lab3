...
SERVER = 'http://192.168.0.205:3000'
...
def get_inbox(recipient: str) -> None:
    ...
    Shows the inbox of the recipient.

    Args: Recipient (str): the recipient of the mail
    Returns: Nothing.
    """
...
def get_sent(sender: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Retrieves the mail that has been sent by the user. 
...
def get_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Retrieves an item of mail when its id is inputted. 
    Args: mail_id(str): the unique string which acts as an identifier for a mail item.
    Returns: Nothing.
    """
...
def delete_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Deletes a certain mail item when given its id. 
    Args: mail_id(str): The unique string which functions as an identifier for a mail item. 
    Returns: Nothing. 
    """
