...
def save_mail(mail: List[Dict[str, str]]) -> None:
    ...
    Saves the list of dictionaries representing mail entries to the json file
    
    Args:
        mail (list): list of dictionaries representing mail entries
    """
...
def add_mail(mail_entry: Dict[str, str]) -> str:
    ...
    Returns:
        str: the unique id for the new mail entry 
    """
    mail = load_mail()
...
def delete_mail(mail_id: str) -> bool:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Deletes mail entry from the json file
    
    Args:
        mail_id (str): the unique id for the mail entry that will be deleted
        
    Returns:
        bool: True if the mail entry is found and deleted; False if not found and deleted 
    """
    mail = load_mail()
...
def get_mail(mail_id: str) -> Optional[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Gets mail entries from the json file 
    
    Args:
        mail_id (str): the mail id for the mail entry being retrieved
        
    Returns: 
        Dict: the dictionary representing the mail entry if it is found
        n/a if mail entry isn't found
    """
    mail = load_mail()
    for entry in mail:
        if entry['id'] == mail_id:
...
def get_inbox(recipient: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Gets the mail entries of the recipient
    
    Args:
        recipient (str): the recipient of the mail entries  
    
    Returns:
        List: list of dictionaries mapping each mail entry to a unique string ID
    """
    mail = load_mail()
    inbox = []
    for entry in mail:
...
def get_sent(sender: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    Gets mail entries sent from a specified sender 
    
    Args:
        sender (str): the sender who sent the mail being retrieved 
    
    Returns:
        List: list of dictionaries of mail entries sent from the specified sender 
    """
    mail = load_mail()
    sent = []
    for entry in mail:
